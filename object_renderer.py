...
class ObjectRenderer:
    ...
    def draw_player_health(self):
        ...
        for i, char in enumerate(health):
            self.screen.blit(self.digits[char], (i * self.digit_size + offset, 0))
        self.screen.blit(self.digits['10'], ((i + 1) * self.digit_size + offset, 0))
    ...
    def draw_background(self):
        ...
        self.screen.blit(self.sky_image_front, (-self.sky_offset, 0))
        self.screen.blit(self.sky_image_back, (-self.sky_offset + WIDTH, 0))
